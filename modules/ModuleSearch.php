	...
	protected function compile()
	{
		...
		if ($strKeywords != '' && $strKeywords != '*' && !$this->jumpTo)
		{
			...
			if ($arrResult === null)
			{
				try
				{
					$result = \Search::searchFor($strKeywords, (\Input::get('query_type') == 'or'), $arrPages, 0, 0, $this->fuzzy, $this->levensthein, $this->maxDist);
				...
				\File::putContent($strCacheFile, json_encode($result));
			}
